...
// Gold flash for achieved milestones
if (achieved) {
const f = document.createElement(‘div’);
f.style.cssText = ‘position:fixed;inset:0;background:radial-gradient(circle,rgba(255,215,0,0.18),transparent 70%);pointer-events:none;z-index:9999;animation:ms-flash 0.7s ease-out forwards;’;
